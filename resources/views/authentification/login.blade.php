                        ...
                        <form method="POST" action="{{ route('users.authenticate') }}">
                            ...
                            <div class="row pb-30">
                                <div class="col-6">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="radio" class="" name="credentials" id="admin">
                                        <label class="" for="admin">Admin</label>
                                        <input type="radio" class="" name="credentials" id="member">
                                        <label class="" for="member">Member</label>
                                    </div>
                                </div>
                                <div class="col-6">
...
document.getElementById('admin').addEventListener('change', function() {
    handleCheckboxChange('admin@gmail.com', '12345678');
});

document.getElementById('member').addEventListener('change', function() {
    handleCheckboxChange('member@gmail.com', '12345678');
});
